...
public class Biblioteca {
	...
	public void agregarLibro (Libro a) throws BiblotecaException {
		...
		if ( lista_libros.length < cantidad_maxima) {
			...
			throw new BiblotecaException(BiblotecaException.BIBLOTECA_LLENA());
		}
	}
	
	public void prestarLibro  (String a) throws BiblotecaException {
		...
		if (!prestado) {
			...
			throw new BiblotecaException(BiblotecaException.LIBRO_PRESTADO());
		}
	}
	
	public void devolverLibro  ( Libro a , int cant_dias_retaso , boolean socio) throws BiblotecaException {
			...
			if (!entrega) {
				throw new BiblotecaException(BiblotecaException.LIBRO_DEVUELTO());
			}
	}
}
