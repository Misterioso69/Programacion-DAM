...
public class Futbolista implements Comparable<Futbolista> {
	...
	public int compareTo(Futbolista o) {
	  ...
	  public static Comparator<Futbolista> ordenarPorNombre = new Comparator<Futbolista>() {
	        @Override
	    ...
	    public static Comparator<Futbolista> ordenarPorEdad = new Comparator<Futbolista>() {
	        @Override
	        public int compare(Futbolista f1, Futbolista f2) {
